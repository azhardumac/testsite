...
$('body a').on('click', function (e) {
  ...
  var classL = this.getAttribute("class");
  if (target != '_blank' && typeof fancybox == 'undefined' && url.indexOf('#') && classL == 'attachment-link'  < 0) {
    ...
    if (url.indexOf('#') != -1) {
      ...
      if ($('body ' + hash).length != 0) {
        $('body').removeClass("page-trns-active");

      }
    } else {
      $('body').toggleClass("page-trns-active");
      setTimeout(function () {
        window.location = url;
      }, 1000);
