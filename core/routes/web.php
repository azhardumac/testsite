...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin','access'])->group(function () {
        ...
        Route::get('users/coin-transaction-histories/{id}', 'ManageUsersController@coinLogs')->name('users.coin.logs');
        Route::get('users/created-auctions/{id}', 'ManageUsersController@auctionCreated')->name('users.auction.created');
        Route::get('users/bought-auctions/{id}', 'ManageUsersController@boughtAuction')->name('users.auction.bought');

        Route::get('users/ticket/{id}', 'ManageUsersController@ticket')->name('users.ticket');
        ...
        //ICOLab
        Route::get('initial-coin-offering-ICO', 'IcoController@manageIcoPage')->name('ico.manage.page');
        Route::post('create-ico', 'IcoController@createIco')->name('ico.create');
        Route::post('delete-ico', 'IcoController@deleteIco')->name('ico.delete');
        Route::post('edit-ico', 'IcoController@editIco')->name('ico.edit');

        Route::get('total-auctions', 'AdminController@totalAuction')->name('auctions');
        Route::get('running-auctions', 'AdminController@runningAuction')->name('auction.running');
        Route::get('backed-auctions', 'AdminController@backedAuction')->name('auction.bakced');
        Route::get('completed-auctions', 'AdminController@completedAuction')->name('auction.completed');

        //White Paper
        Route::get('white-paper-pdf', 'AdminController@whitePaper')->name('whitePaper.pdf');
        Route::post('create-white-paper', 'AdminController@createWhitePaper')->name('whitePaper.create');
        Route::post('delete-white-paper', 'AdminController@deleteWhitePaper')->name('whitePaper.delete');
        Route::post('update-white-paper', 'AdminController@updateWhitePaper')->name('whitePaper.update');

        Route::get('profit-details', 'AdminController@profit')->name('profit');
        Route::get('coin-transaction-history', 'AdminController@coinHistory')->name('coin.history');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            //Transaction log
            Route::get('/transaction-logs', 'UserController@transactionLog')->name('transaction.log');

            //Coin Related Routes
            Route::get('/buy-coin', 'UserController@buyCoin')->name('coin.buy');
            Route::post('/buy-coin-confirm', 'UserController@buyCoinConfirm')->name('coin.buy.confirm');
            Route::get('/buy-coin-logs', 'UserController@buyCoinLog')->name('coin.buy.log');

            Route::get('/create-auction', 'UserController@createAuction')->name('auction.create');
            Route::post('/create-auction', 'UserController@createAuctionConfirm')->name('auction.create.confirm');
            Route::get('/my-auctions', 'UserController@myAuction')->name('auction.my');
            Route::post('/my-auction-back', 'UserController@auctionBack')->name('auction.back');
            Route::get('/auction-list', 'UserController@auctionList')->name('auction.list');
            Route::post('/buy-auction', 'UserController@buyAuction')->name('auction.buy');
            Route::get('/purchased-auctions', 'UserController@auctionPurchasedHistory')->name('auction.buy.history');
...
Route::get('/links/{slug}/{id}', 'SiteController@slugPage')->name('slug.page');
