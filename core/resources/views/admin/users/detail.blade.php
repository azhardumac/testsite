            ...
            <div class="row mb-none-30 justify-content-center">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.users.coin.logs', $user->id) }}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-coins"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{ __($totalCoinLog) }}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Coin Transaction')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
                ...
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.users.auction.created', $user->id) }}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-plus"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{ __($totalAutionCreated) }}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Create Auctions')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
                ...
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.users.auction.bought', $user->id) }}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-shopping-cart"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{ __($totalAuctionBuy) }}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Buy Auctions')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
                 ...
                 <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.users.ticket', $user->id) }}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-ticket"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{ $totalTicket }}</span>
                            </div>
                            <div class="desciption">
