    ...
    <div class="row mb-none-30">
            ...
            <div class="dashboard-w1 bg--gradi-44 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        ...
                        <span class="amount">{{ __($widget['sum_of_coin_transaction']) }}</span>
                        <span class="currency-sign"></span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Coin History')</span>
                    </div>

                    <a href="{{ route('admin.coin.history') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-35 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="currency-sign"></span>
                        <span class="amount">{{ $widget['total_trx'] }}</span>
                    </div>
                    <div class="desciption">
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-7 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="status"></span>
                        <span class="amount">{{ $widget['sum_of_auction'] }}</span>
                        <span class="currency-sign"></span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Auction')</span>
                    </div>

                    <a href="{{ route('admin.auctions') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">View All</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-50 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ $widget['sum_of_subscriber'] }}</span>
                        <span class="currency-sign"></span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Subscriber')</span>
                    </div>

                    <a href="{{ route('admin.subscriber.index') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">View All</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
        ...
        @if($widget['phase'])
          <div class="col-xl-6 col-md-6 mb-30">
            <div class="widget-four b-radius--10 bg--white p-4 box--shadow2 hover--effect1 h-100">
              <div class="widget__icon bg--danger">
                <i class="las la-coins"></i>
              </div>
              <div class="widget__content">
                <p class="mb-2">@lang('Sold') {{ getAmount($widget['phase']['sold']) }}</p>
                <h4>{{ getAmount($widget['phase']['sold'] / ($widget['phase']['coin_token'] + $widget['phase']['sold']) * 100, 1) }}% <span class="badge text--small text--success"></h4>
                <div class="progress box--shadow2 b-radius--5 mt-1" style="height: 4px;">
                  <div class="progress-bar bg--danger" role="progressbar" style="width: {{ $widget['phase']['sold'] / ($widget['phase']['coin_token'] + $widget['phase']['sold']) * 100 }}%" aria-valuenow="82" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <span class="mt-4">@lang('Total Number of Coin') {{ getAmount($widget['phase']['coin_token'] + $widget['phase']['sold']) }} </span>
              </div>
            </div>
          </div>
        @else
        <div class="col-xl-6 col-md-6 mb-30">
            <div class="widget-four b-radius--10 bg--white p-4 box--shadow2 hover--effect1 h-100">
              ...
              <div class="widget__content">
                <span class="mt-4">@lang('Total Number of Coin')</span>
              </div>
            </div>
          </div>
        @endif
        ...
        <div class="col-xl-6 col-md-6 mb-30">
            <div class="widget h-100 border--info b-radius--10 bg--white p-4 box--shadow2 has--link">
              <div class="widget__icon b-radius--rounded bg--info"><i class="las la-calendar"></i></div>
              <div class="widget__content">
                <p class="text-uppercase text-muted">@lang('Ending Date')</p>
                <h2 class="text--info font-weight-bold">
                    @if($widget['phase'])
                        {{ showDateTime($widget['phase']['end_date']) }}
                    @else
                        @lang('N/A')
                    @endif
                </h2>
    ...
    <div class="row mt-50 mb-none-30">
        <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--19 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ getAmount($paymentWithdraw['total_withdraw_charge'], 0) }}{{__($general->cur_text)}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Withdraw Charge')</span>
                    </div>
                    <a href="0#" class="btn btn-sm text--small text--black box--shadow3 mt-3">&nbsp;</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--3 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span>@lang('Approved Withdraw')</span>
                    </div>
        ...
        <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--6 b-radius--10 box-shadow">
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span>@lang('Pending Withdraw')</span>
                    </div>
