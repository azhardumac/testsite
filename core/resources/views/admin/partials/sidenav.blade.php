    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.ico.manage.page')}}">
                    <a href="{{route('admin.ico.manage.page')}}" class="nav-link ">
                        <i class="menu-icon las la-calendar-check"></i>
                        <span class="menu-title">@lang('Manage ICO')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.whitePaper.pdf')}}">
                    <a href="{{route('admin.whitePaper.pdf')}}" class="nav-link ">
                        <i class="menu-icon las la-sticky-note"></i>
                        <span class="menu-title">@lang('White Paper')</span>
                    </a>
                </li>


                <li class="sidebar-menu-item {{menuActive('admin.coin.history')}}">
                    <a href="{{route('admin.coin.history')}}" class="nav-link ">
                        <i class="menu-icon las la-coins"></i>
                        <span class="menu-title">@lang('Coin Log')</span>
                    </a>
                </li>


                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.auction*',3)}}">
                        <i class="menu-icon la la-list"></i>
                        <span class="menu-title">@lang('Auctions Log') </span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.auction*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive(['admin.auction.running'])}}">
                                <a href="{{route('admin.auction.running')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Running')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive(['admin.auction.bakced'])}}">
                                <a href="{{route('admin.auction.bakced')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Backed')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive(['admin.auction.completed'])}}">
                                <a href="{{route('admin.auction.completed')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
