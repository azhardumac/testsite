...
class TicketController extends Controller
{
    ...
    public function storeSupportTicket(Request $request)
    {
        ...
        $ticket->name = $user ? $user->fullname : $request->name;
        $ticket->email = $user ? $user->email : $request->email;
    ...
    {
        $extendTemplate = Auth::user() != null ? $this->activeTemplate.'layouts.master' : $this->activeTemplate.'layouts.frontend';
        $page_title = "Support Tickets";
        ...
        $user = auth()->user();
        return view($this->activeTemplate. 'user.support.view', compact('my_ticket', 'messages', 'page_title', 'user', 'extendTemplate'));
